        ...
        @foreach($merchandises as $key => $merchandise)
          ...
          <div class="col-12 col-md-6 col-lg-3 mb-4">
            <div class="card recom-card" >
              <img src="{{ asset('assets/images/content/merchandise/merchandise') .'/'. $merchandise->image }}" class="card-img-top merchandise-card-img" alt="...">
              <div class="card-body">
                <p class="text-muted mb-2" style="font-size: 10px;">{{ $merchandise->name }}</p>
