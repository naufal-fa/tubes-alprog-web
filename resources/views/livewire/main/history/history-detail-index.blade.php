<section>
  {{-- <!-- Hero Image -->
  <section id="hero-history-details">
    <div class="container">
      <div class="row text-white">
        <div class="col-10 ps-5 ps-md-0">
          <h1 class="display-5 fw-bolder text-uppercase">Detailed information about history of the place you want to visit</h1>
    ...
    <div class="container mt-4">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('history') }}" class="text-decoration-none text-black">History</a></li>
          <li class="breadcrumb-item active" aria-current="page">History Details</li>
        </ol>
      </nav>
  
      <div>
        <h1 class="display-5 fw-bolder text-capitalize">History Title</h1>
        <hr class="mb-5">
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <img src="{{ asset('images/history-img/history-img1.png') }}" class="w-100 rounded" alt="...">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-12 mb-4">
          <h1 class="display-6 fw-bolder text-capitalize mb-3">Description of the history</h1>
        ...
        <div class="col mb-4">
          <div class="info-card card">
            ...
            <div class="card-body">
              ...
              <a href="{{ route('history-details') }}" class="btn btn-primary col-12">Show Details</a>
            </div>
          </div>
        </div>
